...
export function bcTeachingTenure(region: RegionDefinition): NonNullable<RegionDefinition['bcTenure']> {
  ...
  return {
    ...
    stands: Object.fromEntries(region.stands.map((stand, i): [string, BCTenureDefinition] => {
      ...
      return [stand.id, {
        ...
        harvest: {
          ...
          initialStatus: protectedLand || sale || i === 8 || i === 9 ? 'required' : 'approved',
